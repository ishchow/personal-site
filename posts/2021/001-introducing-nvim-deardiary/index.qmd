...
date: 2021-02-07
description: |
  An overview of nvim-deardiary, a Neovim plugin written in Lua for managing multiple journals
  with customizable frequencies, filesystem paths, and templating.
categories: [neovim, lua, nvim-deardiary]
---
