---
title: "Migrating My Blog to Quarto"
date: "2026-03-18"
...
│   │       └── *.gif
│   ├── 2026/
│   │   └── 001-migrating-my-blog-to-quarto/ # Individual post
...
```{.md #lst-pre-merge-post-prompt lst-cap="pre-merge-post.prompt.md"}
...
I only had 3 posts in my old blog but I still wanted to be able to ensure that links weren't broken post migration. Cloudflare has a feature called bulk redirects @cloudflare-bulk-redirects which can basically redirect URLs on a Cloudflare domain. Not being a prolific writer (yet) actually ended up working out in my favor here.

::: {#tbl-bulk-redirects tbl-cap="Bulk redirect mappings from the old Eleventy URL structure to the new Quarto URL structure."}
| **Original URL** | **Redirected URL** |
|---|---|
| https://ishaat.ca/feed.xml | https://ishaat.ca/index.xml |
| https://ishaat.ca/posts/2020/05/20/eleventy-tailwindcss-new-site/ | https://ishaat.ca/posts/2020/001-eleventy-tailwindcss-new-site/ |
| https://ishaat.ca/posts/2021/02/07/introducing-nvim-deardiary/ | https://ishaat.ca/posts/2021/001-introducing-nvim-deardiary/ |
| https://ishaat.ca/posts/2023/02/12/my-ultimate-windows-10-window-management-setup/ | https://ishaat.ca/posts/2023/001-my-ultimate-windows-10-window-management-setup/ |
| https://www.ishaat.ca/feed.xml | https://www.ishaat.ca/index.xml |
| https://www.ishaat.ca/posts/2020/05/20/eleventy-tailwindcss-new-site/ | https://www.ishaat.ca/posts/2020/001-eleventy-tailwindcss-new-site/ |
| https://www.ishaat.ca/posts/2021/02/07/introducing-nvim-deardiary/ | https://www.ishaat.ca/posts/2021/001-introducing-nvim-deardiary/ |
| https://www.ishaat.ca/posts/2023/02/12/my-ultimate-windows-10-window-management-setup/ | https://www.ishaat.ca/posts/2023/001-my-ultimate-windows-10-window-management-setup/ |
:::
