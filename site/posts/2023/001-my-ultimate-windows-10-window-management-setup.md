# My Ultimate Windows 10 Window Management Setup

<time id="post-date" datetime="2023-02-12">2023-02-12</time>
...
![Virtual destkop switcher](win10wmsetup-desktop-switcher.png)
...
![Close notification view](win10wmsetup-close-notifications-view.png)
...
![Color settings](win10wmsetup-personalization-settings-color.png)

Here's what application windows look by default, without active window border highlight.

![Windows Termianl focused with active window border highlight off](win10wmsetup-wt-focused-no-highlight.png)
...
![Windows Terminal focused with active window border highlight on](win10wmsetup-wt-focused-highlight.png)
...
![Taskbar App Numbering](win10wmsetup-taskbar-switch.png)
...
![Windows Multi-tasking Settings](win10wmsetup-multitasking-settings.png)
...
![Windows File Search Settings](win10wmsetup-windows-file-search-settings.png)
...
![Run PowerToys as Admin](win10wmsetup-powertoys-admin.png)
...
![PowerToys Run Settings](win10wmsetup-powertoys-run-settings.png)
...
![PowerToys Run EveryThing Plugin Settings](win10wmsetup-powertoys-run-everything.png)
...
![FancyZones Window Settings](win10wmsetup-fancyzones-window-settings.png)
...
![FancyZones Zone Settings](win10wmsetup-fancyzones-zone-settings.png)
...
![Alt-Tab Terminator](win10wmsetup-alt-tab-terminator.png)
...
![Alt-Tab Terminator Settings: General](win10wmsetup-alt-tab-terminator-settings-general.png)

![Alt-Tab Terminator Settings: Appearance](win10wmsetup-alt-tab-terminator-settings-appearance.png)

![Alt-Tab Terminator Settings: HotKeys](win10wmsetup-alt-tab-terminator-settings-hotkeys.png)
...
![AutoHotkey Installation](win10wmsetup-autohotkey-install.png)
